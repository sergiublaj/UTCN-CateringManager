...
public class AdminPanel extends UserPanel {
   ...
   public void showRichReportPanel() {
      containerPanel.removeAll();

      JPanel titlePanel = new JPanel();
      titlePanel.add(UIFactory.createLabel("Loyal customers | ", ""));
      titlePanel.add(menuButton.get(0));
      containerPanel.add(titlePanel);

      JPanel loyalPanel = new JPanel();
      loyalPanel.add(UIFactory.createLabel("Minimum orders: ", ""));
      loyalPanel.add((JSpinner) reportInputs.get(0));
      loyalPanel.add(UIFactory.createLabel("Minimum price: ", ""));
